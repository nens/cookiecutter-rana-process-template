...
Adjusting the config file for your local test run is not always necessary.
...
If the process reads files from the project, make sure they are available in the project directory.
