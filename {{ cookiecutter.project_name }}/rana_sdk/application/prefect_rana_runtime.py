...
from rana_sdk.infrastructure import (
    ...
    PrefectRanaDatasetGateway,
    PrefectRanaFileGateway,
...
class PrefectRanaRuntime(RanaRuntime):
    ...
    @property
    def file_gateway(self) -> PrefectRanaFileGateway:
        return PrefectRanaFileGateway(self.tenant_id, self.job_id, self.job_secret)

    @property
    def threedi_api_key_gateway(self) -> ThreediApiKeyGateway:
        return ThreediApiKeyGateway(self.tenant_id, self.job_id, self.job_secret)

    @property
    def rana_schematisation_gateway(self) -> PrefectRanaSchematisationGateway:
        return PrefectRanaSchematisationGateway(self.tenant_id, self.job_id, self.job_secret)
    ...
    @property
    def rana_dataset_gateway(self) -> PrefectRanaDatasetGateway:
        return PrefectRanaDatasetGateway(self.tenant_id, self.job_id, self.job_secret)
