...
def test_valid_name():
    ...
    validate_project_name("rana-process-reinout-test")


@pytest.mark.parametrize(
    "name", ["Uppercase", "under_scores", "no-rana-process-prefix"]
)
...
def test_print_instructions():
    print_instructions(project_name="rana-process-example-project")
